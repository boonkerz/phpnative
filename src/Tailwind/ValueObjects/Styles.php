...
namespace PHPNative\Tailwind\ValueObjects;


use PHPNative\Tailwind\Actions\StyleToMethod;
use PHPNative\Tailwind\Enums\Color;
use PHPNative\Tailwind\Exceptions\ColorNotFound;
use PHPNative\Tailwind\Repositories\Styles as StyleRepository;
use Closure;
...
final class Styles
{
    ...
    final public function border(int $width = 1): self
    {
        return $this;
    }
    ...
    private function getColorVariant(string $color, int $variant): string
    {
        ...
        return Color::fromName($colorConstant)->value;
    }
